...
define('fuelux/pillbox',['require','jquery'],function(require) {
	...
	Pillbox.prototype = {
		...
		itemclicked: function(e) {
			...
			if(typeof(this.options.itemclicked) ==  "function") {this.options.itemclicked(data);return;}
		...
		addItem: function(text, value) {
			...
			if(typeof(this.options.added) ==  "function") {this.options.added( { text: text, value: value });}
