<%@include file='/WEB-INF/jsp/module/insuranceCompany/controller/insuranceCompany.main.js.jsp' %> 
<%@ taglib prefix="css" uri="/WEB-INF/mnt.tld"%>

<div class="box">
	<css:FormHeader cssclass="box-header-mini">Insurance Company</css:FormHeader>
