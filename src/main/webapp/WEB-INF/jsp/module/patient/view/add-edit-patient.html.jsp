    ...
    <div class="modal-footer">
            <button data-ng-show="patientForm.id == null" class="btn btn-primary" ng-click="savePatient()">Save</button>
            <button data-ng-show="patientForm.id != null" class="btn btn-primary" ng-click="updatePatient()">Update</button>
    </div>
