...
@Entity
public class TertiaryInsurance extends Model {
	@Id
	public Long id;
	
	public String tertiaryInsuranceProvider;
	...
	public String getPrimaryInsuranceProvider() {
		return tertiaryInsuranceProvider;
	}
	public void setPrimaryInsuranceProvider(String primaryInsuranceProvider) {
		this.tertiaryInsuranceProvider = primaryInsuranceProvider;
	}
